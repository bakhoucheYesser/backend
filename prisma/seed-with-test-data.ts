...
import { PrismaClient, Prisma, EstimateStatus, BookingStatus, PaymentStatus } from '@prisma/client';
...
async function main() {
  ...
  await prisma.user.deleteMany({
    where: {
      email: {
        in: ['marie.tremblay@email.com', 'jean.lapointe@email.com', 'sophie.gagnon@email.com', 'admin@grandogo.com']
      }
    }
  });
