...
async function main() {
  ...
  const provider1 = await prisma.provider.upsert({
    ...
    create: {
      ...
      totalJobs: 127,
      totalEarnings: new Prisma.Decimal(15750.50),
  ...
  // Provider 2 - 7 jours sur 7 (grosse entreprise)
  ...
  await prisma.notification.create({
    data: {
      ...
      message: 'Vous avez reçu une nouvelle demande de réservation pour demain à 10h00.',
  ...
  // 12. ZONES DE SERVICE (déjà créées par la migration)
  ...
  console.log(`   - Disponibilités: ${stats.providerAvailabilities}`);
